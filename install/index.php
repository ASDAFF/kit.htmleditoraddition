...
class kit_htmleditoraddition extends CModule
{
    const MODULE_ID = 'kit.htmleditoraddition';
    var $MODULE_ID = 'kit.htmleditoraddition';
    var $MODULE_VERSION;
    ...
    function __construct()
    {
        ...
        $this->MODULE_NAME = GetMessage('kit.htmleditoraddition_MODULE_NAME');
        $this->MODULE_DESCRIPTION = GetMessage('kit.htmleditoraddition_MODULE_DESC');
        $this->PARTNER_NAME = GetMessage('kit.htmleditoraddition_PARTNER_NAME');
        $this->PARTNER_URI = GetMessage('kit.htmleditoraddition_PARTNER_URI');
    }
    ...
    {
        RegisterModuleDependences('fileman', 'OnBeforeHTMLEditorScriptRuns', self::MODULE_ID, 'CKitHtmlEditorAddition', 'OnIncludeHTMLEditorScriptRuns');
        return true;
    }
    ...
    {
        UnRegisterModuleDependences('fileman', 'OnBeforeHTMLEditorScriptRuns', self::MODULE_ID, 'CKitHtmlEditorAddition', 'OnIncludeHTMLEditorScriptRuns');
        return true;
    }
