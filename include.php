...
class CKitHtmlEditorAddition
{
    const MODULE_ID = 'kit.htmleditoraddition';
    const KIT_HTML_EDITOR_COOKIES = 'kit_html_editor_params';
    ...
    public static function getIdCollectionDefault()
    {
        if (\Bitrix\Main\Loader::includeModule('fileman')) {
            CMedialib::Init();
            $_1593227664 = array('arFields' => array('NAME' => 'kit.htmleditoraddition', 'PARENT_ID' => 0, 'ACTIVE' => 'Y', 'ML_TYPE' => '1'), 'arFilter' => array('NAME' => 'kit.htmleditoraddition'));
    ...
    public static function deleteCookieHtmlEditor()
    {
        ...
        if (static::$_1301099690 === false) {
            static::log(static::EVENT_SERVER_NAME_ERROR, Loc::getMessage("KIT_HTMLEDITORADDITION_V_NASTROYKAH_GLAVNOG") . static::KIT_HTML_EDITOR_COOKIES . ' ' . Loc::getMessage("KIT_HTMLEDITORADDITION_U_POLQZOVATELA_NE_UD"));
        } else {
            setcookie(static::KIT_HTML_EDITOR_COOKIES, '', false, '/', static::$_1301099690, false, true);
        }
    }
    ...
    function getDemo()
    {
        ...
        if ($_149911671 == 3) {
            echo Loc::getMessage('KIT_HTML_EDITOR_ADDITION_DEMO');
            return false;
        } else return true;
    }
    ...
    public function OnIncludeHTMLEditorScriptRuns()
    {
        ...
        if ($APPLICATION->GetFileAccessPermission('upload/') > 'U') {
            CJSCore::RegisterExt('kit_htmleditor_additional', array('js' => '/bitrix/tools/' . self::MODULE_ID . '/js/script.js', 'lang' => '/bitrix/modules/' . self::MODULE_ID . '/lang/' . LANGUAGE_ID . '/install/tools/' . self::MODULE_ID . '/js/script.php', 'rel' => array('fileinput'),));
            CJSCore::Init(array('kit_htmleditor_additional'));
        }
    }
    ...
    public function modalImagesShow()
    {
        if (class_exists('\Bitrix\Main\UI\FileInput', true) && isset($_REQUEST['name_input'])) {
            ...
            $_1057032277 .= '<tr>';
            $_1057032277 .= '<td width="50%" style="text-align: right">' . Loc::getMessage('KIT_HTML_EDITOR_MODAL_IMAGES_PARAMS_SELECT_COLLECTION') . ':</td>';
            $_1057032277 .= '<td>';
            $_1057032277 .= CKitHtmlEditorAddition::getSelectBoxCollection($_REQUEST['name_input'] . '_collection', $_1219281716[$_REQUEST['name_input'] . '_collection'], 1);
            $_1057032277 .= '</td>';
            $_1057032277 .= '</tr>';
            $_1057032277 .= '<tr>';
            $_1057032277 .= '<td width="50%" style="text-align: right">' . Loc::getMessage('KIT_HTML_EDITOR_MODAL_IMAGES_PARAMS_ADD_BR') . ':</td>';
            $_1057032277 .= '<td>';
    ...
    public static function getCookieHtmlEditor()
    {
        static::$_1301099690 = static::getServerName();
        if (static::$_1301099690 === false) {
            static::log(static::EVENT_SERVER_NAME_ERROR, Loc::getMessage("KIT_HTMLEDITORADDITION_V_NASTROYKAH_GLAVNOG") . static::KIT_HTML_EDITOR_COOKIES . ' ' . Loc::getMessage("KIT_HTMLEDITORADDITION_POLQZOVATELU_NE_USTA"));
        } elseif (isset($_COOKIE[static::KIT_HTML_EDITOR_COOKIES])) {
            return unserialize(stripcslashes($_COOKIE[static::KIT_HTML_EDITOR_COOKIES]));
        }
        return null;
    }
    ...
    public static function getListCollection($_980747474 = 1)
    {
        ...
        if (\Bitrix\Main\Loader::includeModule('fileman')) {
            ...
            if (empty($_1036837479)) {
                $_1593227664 = array('arFields' => array('NAME' => Loc::getMessage('KIT_HTMLEDITORADDITION_COLLECTION_MEDIA_NAME_' . $_980747474), 'PARENT_ID' => 0, 'ACTIVE' => 'Y', 'ML_TYPE' => $_980747474, 'DESCRIPTION' => Loc::getMessage('KIT_HTMLEDITORADDITION_COLLECTION_MEDIA_DESCRIPTION')),);
                $_455699908 = CMedialibCollection::Edit($_1593227664);
                $_1036837479 = CMedialibCollection::GetList(array('arFilter' => array('ACTIVE' => 'Y', 'ML_TYPE' => $_980747474), 'arOrder' => array('NAME' => 'ASC')));
            }
        }
    ...
    public function modalVideoShow()
    {
        if (class_exists('\Bitrix\Main\UI\FileInput', true) && isset($_REQUEST['name_input'])) {
            ...
            $_1057032277 .= '<table class="adm-detail-content-table edit-table" style="opacity: 1; width: 100%;">';
            $_1057032277 .= '<tr>';
            $_1057032277 .= '<td width="50%" style="text-align: right">' . Loc::getMessage('KIT_HTML_EDITOR_MODAL_VIDEOS_PARAMS_SELECT_COLLECTION') . ':</td>';
            $_1057032277 .= '<td>';
            $_1057032277 .= CKitHtmlEditorAddition::getSelectBoxCollection($_REQUEST['name_input'] . '_collection', $_1219281716[$_REQUEST['name_input'] . '_collection'], 2);
            $_1057032277 .= '</td>';
            $_1057032277 .= '</tr>';
            $_1057032277 .= '<tr>';
            $_1057032277 .= '<td width="50%" style="text-align: right">' . Loc::getMessage('KIT_HTML_EDITOR_MODAL_VIDEOS_PARAMS_ADD_BR') . ':</td>';
            $_1057032277 .= '<td>';
            if ($_1219281716 != null && $_1219281716[$_REQUEST['name_input'] . '_addTagsBr'] == 'N') {
                $_1057032277 .= '<input id="' . $_REQUEST['name_input'] . '_addTagsBr" class="adm-designed-checkbox" type="checkbox" value="Y" name="' . $_REQUEST['name_input'] . '_addTagsBr">';
            } else {
            ...
            $_1057032277 .= '</tr>';
            $_1057032277 .= '<tr>';
            $_1057032277 .= '<td width="50%" style="text-align: right">' . Loc::getMessage('KIT_HTML_EDITOR_MODAL_VIDEOS_PARAMS_HEIGHT') . ':</td>';
            $_1057032277 .= '<td>';
            ...
            $_1057032277 .= '</tr>';
            $_1057032277 .= '<tr>';
            $_1057032277 .= '<td width="50%" style="text-align: right">' . Loc::getMessage('KIT_HTML_EDITOR_MODAL_VIDEOS_PARAMS_WIDTH') . ':</td>';
            $_1057032277 .= '<td>';
    ...
    public static function setCookieHtmlEditor($_2127951999)
    {
        ...
        if (static::$_1301099690 === false) {
            ...
            setcookie(static::KIT_HTML_EDITOR_COOKIES, serialize($_2127951999), false, '/', static::$_1301099690, false, true);
        }
    }
